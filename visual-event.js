...
var EventLoader = {
	...
	fnComplete: function ()
	{
		...
		nInfo.innerHTML = '<span class="Event_header">Visual Event</span> (v.10) - by Allan Jardine<br>'+
			...
			'<div><a href="https://www.sprymedia.co.uk/article/Visual+Event" target="_blank">'+
	...
	fnLoad: function ()
	{
		...
		/* Deploy */
		EventLoader.fnLoadFile( 'https://www.sprymedia.co.uk/design/event/media-0.10/css/event.css',        'css' );

		if ( typeof jQuery == 'undefined' )
		{
			EventLoader.jQueryPreLoaded = false;
			EventLoader.fnLoadFile( 'https://www.sprymedia.co.uk/design/event/media-0.10/js/event-complete-jquery.js', 'js' );
		}
		else
		{
			EventLoader.jQueryPreLoaded = true;
			EventLoader.fnLoadFile( 'https://www.sprymedia.co.uk/design/event/media-0.10/js/event-complete.js', 'js' );
		}
